...
# ── Endpoint 2 — Filters product by category ──────────────────
...
# ── Endpoint 3 — Returns only instock products ──────────────────
...
# ── Endpoint 4 — Returns summary of store ──────────────────
...
# ── Endpoint 6 — Best deal and premium product ──────────────────
